...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/24 14:30:47 by rtodaro           #+#    #+#             */
/*   Updated: 2025/01/24 14:30:48 by rtodaro          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_manual(void)
{
	...
	ft_printf("|----------------------------|\n");
	ft_printf("|  \033[1;33marrows\033[0m: ");
	ft_printf("\033[1;32mmove the fractal\033[0m  |\n");
	ft_printf("|                            |\n");
	ft_printf("|  \033[1;33mc\033[0m: ");
	ft_printf("\033[1;32mchange color\033[0m           |\n");
	ft_printf("|                            |\n");
	ft_printf("|  \033[1;33mmouse wheel\033[0m: ");
	ft_printf("\033[1;32mzoom in/out\033[0m  |\n");
	ft_printf("------------------------------\n");
}
